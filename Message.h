...
typedef enum : unsigned char {
	...
	C_SYSTEM					= 3, //!< Internal MySensors messages (also include common messages provided/generated by the library).
	C_STREAM					= 4, //!< For firmware and other larger chunks of data that need to be divided into pieces.
	C_ACK							= 5	 //!< Sensor command that send an ACK for the last received command
} Sensor_command;
